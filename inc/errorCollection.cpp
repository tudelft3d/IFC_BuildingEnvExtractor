...
ErrorCollection::ErrorCollection() {
	...
	errorMap_ = {
		...
		{ErrorID::failedLoDb0, ErrorObject("E0060", "LoDb.0 creation failed")},
		{ErrorID::failedLoDc1, ErrorObject("E0061", "LoDc.1 creation failed")},
		{ErrorID::failedLoDc2, ErrorObject("E0062", "LoDc.2 creation failed")},
		{ErrorID::failedLoDd1, ErrorObject("E0063", "LoDd.1 creation failed")},
		{ErrorID::failedLoDd2, ErrorObject("E0064", "LoDd.2 creation failed")},
		{ErrorID::failedLoDe1, ErrorObject("E0065", "LoDe.1 creation failed")},
		{ErrorID::failedLoD32, ErrorObject("E0032", "LoD3.2 creation failed")},
		{ErrorID::failedLoD40, ErrorObject("E0032", "LoD4.0 creation failed")},
		{ErrorID::failedLoD41, ErrorObject("E0032", "LoD4.1 creation failed")},
		{ErrorID::failedLoD42, ErrorObject("E0032", "LoD4.2 creation failed")},
